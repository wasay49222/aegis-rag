...
export default function Sidebar() {
  ...
  // suppressHydrationWarning prevents the benign Next.js hydration mismatch 
  // caused by usePathname() and localStorage-based auth stores.
  return (
    <aside 
      className="w-64 border-r border-slate-800 bg-[#0b111e] flex flex-col h-screen sticky top-0" 
